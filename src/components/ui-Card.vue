<template>
  <div class="main__card card">
    <div class="card__icon_delete">
      <svg class="card__icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="card__wrapper-img">
      <img class="card__img" src="@/assets/logo.png" alt="#" srcset="" />
    </div>
    <div class="card__content">
      <div class="card__header">Наименование товара</div>
      <div class="card__info">
        Довольно-таки интересное описание товара в несколько строк. Довольно-таки интересное описание товара в несколько
        строк
      </div>
