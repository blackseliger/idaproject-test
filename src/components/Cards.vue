    ...
    <template v-else>
      <div class="main__card card">
        ...
        <div class="card__content">
          ...
          <div class="card__info">
            Привет! Должно быть вы не добавили товары или решили проверить, а что если карточек не будет, поэтому тут только по умолчанию карточка с котиком! :D 
            Плюсы: Вы видите котика.
            Минусы: Печеньки его, а не ваши :P
          </div>
