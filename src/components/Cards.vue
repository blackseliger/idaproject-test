    ...
    <transition name="fade">
        ...
        <transition-group name="cards">
          <div v-for="card in goods" :key="card.id" class="main__card card">
            ...
            <div class="card__wrapper-img">
              <img class="card__img" :src="card.scrImg" alt="card image" srcset="" />
            </div>
      ...
      <template v-else>
        <div class="main__card card">
          <div class="card__wrapper-img">
            <img class="card__img" src="../assets/cat.jpg" alt="card image" srcset="" />
          </div>
          <div class="card__content">
            <div class="card__header">Кот с печеньками</div>
            <div class="card__info">
              Привет! Должно быть вы не добавили товары или решили проверить, а что если карточек не будет, поэтому тут
              только по умолчанию карточка с котиком! :D Плюсы: Вы видите котика. Минусы: Печеньки его, а не ваши :P
            </div>
            <div class="card__price">Бесценно (^・ω・^ )</div>
          </div>
        </div>
      </template>
    </transition>
